...
import { LogIn, Phone, Volume2, Loader2, AlertCircle } from 'lucide-react';
    ...
    <div className="h-screen w-full flex flex-col p-6 items-center justify-center bg-bg-primary relative overflow-hidden">
      ...
      <div className="w-full max-w-sm bg-bg-card p-8 rounded-[32px] shadow-[var(--shadow-header)] border border-border/50 text-center relative z-10">
        ...
        {phoneStep === 'input' ? (
          <>
            ...
            <button
              ...
              className="btn-accent w-full py-3.5 mb-6 text-base disabled:opacity-60 flex items-center justify-center gap-2"
            >
        ...
        <button
          ...
          disabled={loading}
          className="w-full bg-bg-card border border-border/60 text-text-primary font-bold py-3.5 rounded-xl flex items-center justify-center gap-3 hover:bg-bg-primary transition-all duration-300 shadow-sm active:scale-95 disabled:opacity-60"
        >
          {loading ? (
